...
```go
var DefaultRuleSeparator = ","      // Default separator for validation rules
var DefaultParamSeparator = ":"     // Default separator for rule parameters
var DefaultParamListSeparator = "," // Default separator for parameter lists
```
