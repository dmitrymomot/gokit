...
The `i18nx` package provides a simple, powerful internationalization (i18n) solution for Go applications. It supports multiple languages, custom translation files, and extensive error handling to make your applications globally accessible.
...
```bash
go get -u github.com/dmitrymomot/gokit/i18nx
```
...
func main() {
	...
	translator, err := i18nx.New(i18nx.Config{
		DefaultLanguage: "en",
...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	lang := i18nx.ParseAcceptLanguage(r.Header.Get("Accept-Language"), 
		[]string{"en", "fr", "es"}, "en")
...
translator, err := i18nx.New(i18nx.Config{
	...
	LogLevel: i18nx.LogLevelInfo, // Set log level
